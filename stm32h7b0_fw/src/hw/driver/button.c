...
{
  {GPIOD, GPIO_PIN_11, GPIO_PIN_RESET, GPIO_PIN_SET}, // 0. LEFT
  {GPIOD, GPIO_PIN_15, GPIO_PIN_RESET, GPIO_PIN_SET}, // 1. RIGHT
  {GPIOD, GPIO_PIN_0,  GPIO_PIN_RESET, GPIO_PIN_SET}, // 2. UP
  {GPIOD, GPIO_PIN_14, GPIO_PIN_RESET, GPIO_PIN_SET}, // 3. DOWN
  {GPIOD, GPIO_PIN_9,  GPIO_PIN_RESET, GPIO_PIN_SET}, // 4. A
  {GPIOD, GPIO_PIN_5,  GPIO_PIN_RESET, GPIO_PIN_SET}, // 5. B
  {GPIOC, GPIO_PIN_1,  GPIO_PIN_RESET, GPIO_PIN_SET}, // 6. GAME
  {GPIOC, GPIO_PIN_5,  GPIO_PIN_RESET, GPIO_PIN_SET}, // 7. TIME
  {GPIOC, GPIO_PIN_13, GPIO_PIN_RESET, GPIO_PIN_SET}, // 8. PAUSE/SET
  {GPIOA, GPIO_PIN_0,  GPIO_PIN_RESET, GPIO_PIN_SET}, // 9. POWER
};
